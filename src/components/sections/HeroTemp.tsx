      ...
      <div className="absolute inset-0 mx-auto px-8 lg:px-16 flex flex-col lg:flex-row items-center justify-between gap-12">
        ...
        >
          ...
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.6, delay: isBackgroundReady ? 1.5 : 2 }}
          ...
          >
            ...
            <motion.a
              ...
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.98 }}
              className="px-8 py-3 rounded-lg border-2 border-[#acb8f7] text-[#acb8f7] font-semibold hover:bg-[#acb8f7] hover:text-[#0a0f28] transition-colors duration-300"
            >
              See My Work
            </motion.a>
          </motion.div>
          ...
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.6, delay: isBackgroundReady ? 1.7 : 2.2 }}
